    	...
    	<div id="body">
        	<div id="body_top">
                <table style="width:100%; height:100%;">
            		<tr><td><span>您现在的位置：</span><span><a href="../../">首页</a>--></span><span><a href="../">后台管理</a>--></span><span><a href="./managers_manage.php">管理员</a>--></span><span><a href="">管理员信息修改</a></span></td><td align="right"><span><a href="../../Logout.php">【退出】</a></span></td></tr>
            	</table>
            </div>
            ...
            <tr  align="left"><td width="20%">用户名：</td><td ><input type="text" name="name" value="<?php echo $data['name'];?>" id="name"/></td></tr>
