	...
	<div id="all">
        ...
        <div id="body">
            ...
            <table id="func" align="center">
            	<tr><td><input type="button" id="deletes"  value="批量添加" onclick="Pre_deletes()"/><input type="button" onclick="checkall()" value="全选"/><input type="button" onclick="cleanup()" value="清除"/></td><td><input type="button" id="ok" value="确认添加" onclick="deletes()"/></td><td><input type="text" name="search" id="search" /><input type="button" value="搜索" onclick="_search()"/></td></tr>
            </table>
